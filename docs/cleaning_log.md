...
- The 5× median outlier rule is dataset-specific; a genuinely 5×-ing stock (rare, but possible) would be wrongly flagged. The validation gate (validate.py) adds a second safety net.
